...
public class AddClothesController extends SelectorComposer<Component>  {
   ...
   public void addClothes() {
    // Thêm ảnh vào thư mục img
   	...
   	boolean result = clothesService.insert(clothes);
   	if (!result) {
